...
const Bento1 = () => (
  <motion.div className="rounded-3xl p-8 bg-linear-to-l from-yellow-50 to-white border border-yellow-100 overflow-hidden">
...
const Bento4 = () => (
  <motion.div className="bg-[#E9F1FA] rounded-3xl flex flex-col items-center justify-center gap-4 p-8">
    <Moon size={52} className="text-[#3C5060]" />
    <h3 className="text-[#3C5060] text-lg font-medium">
      Have you had enough sleep today?
    </h3>
    <div className="flex gap-3">
      <button className="px-4 py-2 rounded-full bg-[#bfdbfb] shadow text-sm text-gray-600">
        Nah
      </button>
      <button className="px-4 py-2 rounded-full bg-[#bfdbfb] shadow text-sm text-gray-600">
        💤
  ...
  const items = [
    {
      ...
      label: "Sleep",
      color: "bg-blue-200",
      stat: "Avg: 7 hrs 15 min",
    },
    {
      icon: <GiRunningShoe size={20} />,
      label: "Jogging",
      color: "bg-green-200",
      stat: "Avg: 1 hr 10 min",
    },
    {
      icon: <GrYoga size={20} />,
      label: "Meditation",
